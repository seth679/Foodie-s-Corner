...
class VerifiedSellersScreen extends StatefulWidget {
  const VerifiedSellersScreen({Key? key}) : super(key: key);
...
class _VerifiedSellersScreenState extends State<VerifiedSellersScreen> {
  ...
  void initState() {
    ...
    FirebaseFirestore.instance
        ...
        .get().then((verifiedSellers)
    {
      setState(() {
        allSellers = verifiedSellers;
      });
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: SimpleAppBar(title: "Verified Sellers Accounts",),
      body: Center(
        child: Container(
